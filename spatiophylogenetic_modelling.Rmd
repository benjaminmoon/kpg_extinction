...
The data file can then be loaded into R, which gives a list with length two: the first element (`$elapsed_time`) gives the original download time and the second element (`$records`) is a `data.frame` of the PBDB occurrence data. We keep just this second part.

```{r read_pbdb_data}
bivalve_pbdb_file <- "2022-03-18-bivalve_pbdb_occurrences.json"

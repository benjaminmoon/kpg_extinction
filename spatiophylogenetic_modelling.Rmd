...
occ_ranges_absolute <-
  occ_checking %>%
  cf_range(taxon = "tna", min_age = "lag", max_age = "eag", method = "time", max_range = 35, value = "flagged")
...
# occ_outliers_total <-
#   occ_checking %>%
#   cf_outl(taxon = "", lat = "lat", lon = "lng", min_age = "lag", max_age = "eag", value = "flagged")
